...
<input type="text" name="education" class="form-control" value="<?= isset($education) ? $education->education : '' ?>">
</div>
            <div class="mb-3">
                <label class="form-label">Education Level</label><br>
                <div class="form-check form-check-inline">
                    <input type="radio" name="education_level" value="B.Com" <?= (isset($education->edu_level) && $user->edu_level == 'B.Com') ? 'checked' : '' ?>>
                    <label class="form-check-label text-white">B.Com</label>
                </div>
                <div class="form-check form-check-inline">
                    <input type="radio" name="education_level" value="B.Sc.It" <?= (isset($education->edu_level) && $user->edu_level == 'B.Sc.It') ? 'checked' : '' ?>>
                    <label class="form-check-label text-white">B.Sc.It</label>
                </div>
                <div class="form-check form-check-inline">
                    <input type="radio" name="education_level" value="MCA" <?= (isset($education->edu_level) && $user->edu_level == 'MCA') ? 'checked' : '' ?>>
                    <label class="form-check-label text-white">MCA</label>
                </div>
            </div>
...
<div class="mb-3">
    ...
    <select name="institute" class="form-select">
        ...
        <option value="Mumbai University" <?= isset($user) && $user->institute == 'Mumbai University' ? 'selected' : '' ?>>Mumbai University</option>
        <option value="Pune University" <?= isset($user) && $user->institute == 'Pune University' ? 'selected' : '' ?>>Pune University</option>
        <option value="Chatrapati Shivaji Maharaj University" <?= isset($user) && $user->institute == 'Chatrapati Shivaji Maharaj University' ? 'selected' : '' ?>>Chatrapati Shivaji Maharaj University</option>
        <option value="Amity University" <?= isset($user) && $user->institute == 'Amity University' ? 'selected' : '' ?>>Amity University</option>
    </select>
</div>
            <div class="mb-3">
